...
<body>
    ...
    <footer>
        <div class="footer-content">
            <div>
                <h3>About Aguilar Dental Clinic Co</h3>
                <p>ADC is an oral health provider that offers a variety of services. Quality dental care that is aimed to educate patients to be proactive of dental health."</p>
            </div>
            <div>
                <h3>Contact Us</h3>
                <p>Phone:  0955 908 1184</p>
                <p>Address: Unit 4 BU Entrep Centrum, Daraga, Albay,  Bicol University, Daraga Campus, Philippines</p>
            </div>
        </div>
        <div class="social-media">
            <a href="https://www.https://mm.mymedsph.com/dental/WqqtACL"><i class="fab fa-facebook"></i></a>
        </div>
    </footer>
</body>
</html>
